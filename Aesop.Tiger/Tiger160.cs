// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Tiger160.cs" company="Always Elucidated Solution Pioneers, LLC">
...
namespace Aesop
{
    ...
    /// <summary>
    /// Tiger hash, 160-bit implementation.
    /// </summary>
    /// <seealso cref="Tiger192" />
    public class Tiger160 : Tiger192
    {
        ...
        /// <exception cref="T:System.RankException"> sourceArray and destinationArray have different ranks.</exception>
        /// <exception cref="T:System.ArgumentNullException"> sourceArray is <see langword="null" />.-or-
        /// destinationArray is <see langword="null" />.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException"> sourceIndex is less than the lower bound of the first
        ...
        /// <exception cref="T:System.ArgumentException"> length is greater than the number of elements from sourceIndex to the
        ...
        /// <exception cref="T:System.ArrayTypeMismatchException"> sourceArray and destinationArray" are of incompatible
        /// types.</exception>
        /// <exception cref="T:System.InvalidCastException">At least one element in sourceArray" cannot be cast to the type of
        /// destinationArray.</exception>
        /// <exception cref="T:System.OverflowException">The array is multidimensional and contains more than
