// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Tiger128Tests.cs" company="Always Elucidated Solution Pioneers, LLC">
...
#pragma warning restore CA1515 // Consider making public types internal
{
    ...
    /// <summary>
    /// Runs the self-test of the <see cref="Tiger128" /> class and asserts its failure.
    /// </summary>
    [TestMethod]
    //// ReSharper disable once UnusedMember.Global
    ...
    /// <summary>
    /// Runs the self-test of the <see cref="Tiger128" /> class in span mode and asserts its failure.
    /// </summary>
    [TestMethod]
    //// ReSharper disable once UnusedMember.Global
    ...
    //// ReSharper disable once UnusedMember.Global
    public void TestExtraPassesTryPass()
    {
        const string TestData = "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq12345678";
        byte[] testHash =
        [
