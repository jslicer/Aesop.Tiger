// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Tiger192Tests.cs" company="Always Elucidated Solution Pioneers, LLC">
...
namespace Aesop.Tiger.Tests
{
    ...
    /// </summary>
    [TestClass]
    public sealed class Tiger192Tests
    {
        /// <summary>
        ...
        {
            using TigerFull h = new Tiger192(DefaultPasses);
        ...
        {
            using TigerFull h = new Tiger192();
        ...
        public void TestExtraPasses()
        {
            ...
            using TigerFull h = new Tiger192(DefaultPasses + 1);
